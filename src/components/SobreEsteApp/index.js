...
<h2>Aviso legal:</h2>
<p>
Este aplicativo está situado em uma página da web e não está programado para identificar sua identidade, localização, ou rede. ara seu uso também não exigirá nenhum download de arquivo em seu dispositivo. Para o seu funcionamento não irá solicitar dados de identificação pessoal ou qualquer outra informação para fins de cadastro. Por fim, esta aplicação tampouco registrará os dados que forem imputados por você em qualquer banco de dados.
Desta forma, você poderá utilizar para fins de consulta pessoal, para outra pessoa ou até mesmo de forma educativa, criando e testando múltiplos cenários de acordo com sua necessidade.
</p>
<h2>Autores:</h2>
...
<h2>Contato:</h2>
<p>
<a href="mailto:voebemapp@gmail.com" title="mailto:voebemapp@gmail.com" target="_blank" rel="noopener noreferrer" class="i0jNr selectable-text copyable-text">voebemapp@gmail.com</a>
</p>
<h2>Bibliografia:</h2>
...
<p>CFM. Conselho Federal de Medicina. Medicina aeroespacial: orientações gerais para médicos a bordo. Conselho Federal de Medicina, Brasília/DF: CFM, 2018. <a href="https://portal.cfm.org.br/images/PDF/cartilhaaeroespcaial2018.pdf" title="https://portal.cfm.org.br/images/PDF/cartilhaaeroespcaial2018.pdf" target="_blank" rel="noopener noreferrer" class="i0jNr selectable-text copyable-text">https://portal.cfm.org.br/images/PDF/cartilhaaeroespcaial2018.pdf</a></p>

<p>FCM SANTA CASA. Faculdade de Ciências Médicas da Santa Casa de São Paulo. Doutor, posso viajar de avião? -Cartilha de Medicina Aeroespacial. Faculdade de Ciências Médicas da Santa Casa de São Paulo, Brasília: Conselho Federal de Medicina, 2011. <a href="http://portal.cfm.org.br/images/stories/pdf/cartilha_medicina_aeroespacialfinal2.pdf" title="http://portal.cfm.org.br/images/stories/pdf/cartilha_medicina_aeroespacialfinal2.pdf" target="_blank" rel="noopener noreferrer" class="i0jNr selectable-text copyable-text">http://portal.cfm.org.br/images/stories/pdf/cartilha_medicina_aeroespacialfinal2.pdf</a></p>

<p>Presidência da República. Secretaria-Geral. Subchefia para Assuntos Jurídicos. LEI Nº 13.709, DE 14 DE AGOSTO DE 2018. Lei Geral de Proteção de Dados Pessoais (LGPD). Disponível em: <a href="https://www.planalto.gov.br/ccivil_03/_Ato2015-2018/2018/Lei/L13709.htm#ementa" title="https://www.planalto.gov.br/ccivil_03/_Ato2015-2018/2018/Lei/L13709.htm#ementa" target="_blank" rel="noopener noreferrer" class="i0jNr selectable-text copyable-text">https://www.planalto.gov.br/ccivil_03/_Ato2015-2018/2018/Lei/L13709.htm#ementa</a> Acesso em 27 nov. 2022.</p>

<h2>Atribuição de ícone e das imagens do Web App:</h2>
